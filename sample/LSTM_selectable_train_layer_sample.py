...
from model.LSTM_selectable_train_layer import LSTM
import random
import numpy as np
...
class Config:
    ...
    input_size = 100
    label_size = 10
    # cell_size_list = [(100, True), (100, True), (100, True)]
    cell_size_list = [(100, False), (100, False), (100, True)]
    keep_prob = 0.9
...
# 特定のcellだけが学習対象になっているかを調べるために、固定のデータ・セットを渡すように変更
